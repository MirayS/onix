...
use MirayS\Onix\CodeList\CodeList239;
use MirayS\Onix\CodeList\CodeList49;
use MirayS\Onix\CodeList\CodeList91;

class SupplyContact
{
    private ?CodeList239 $SupplyContactRole = null;

    private array $SupplyContactIdentifier = [];

    private ?string $SupplyContactName = null;
    ...
    public function setSupplyContactRole(CodeList239 $supplyContactRole): static
    {
        $this->SupplyContactRole = $supplyContactRole;

        return $this;
    }

    public function getSupplyContactRole(): ?CodeList239
    {
        return $this->SupplyContactRole;
    }

    public function addSupplyContactIdentifier(SupplyContactIdentifier $supplyContactIdentifier): static
    {
        $this->SupplyContactIdentifier[] = $supplyContactIdentifier;

        return $this;
    }

    public function getSupplyContactIdentifier(): array
    {
        return $this->SupplyContactIdentifier;
    }

    public function removeSupplyContactIdentifier(SupplyContactIdentifier $supplyContactIdentifier): static
    {
        $this->SupplyContactIdentifier = array_values(array_filter(
            $this->SupplyContactIdentifier,
            static fn ($item): bool => $item !== $supplyContactIdentifier,
        ));

        return $this;
    }

    public function setSupplyContactName(string $supplyContactName): static
    {
    ...
    public function getSupplyContactName(): ?string
    {
        return $this->SupplyContactName;
    }
