...
class NameAsSubject
{
    ...
    private array $SubjectDate = [];

    private array $ProfessionalAffiliation = [];

    private array $SubjectDescription = [];
    ...
    public function addSubjectDate(SubjectDate $subjectDate): static
    {
    ...
    public function getSubjectDate(): array
    {
        return $this->SubjectDate;
    }

    public function removeSubjectDate(SubjectDate $subjectDate): static
    {
        $this->SubjectDate = array_values(array_filter(
            $this->SubjectDate,
            static fn ($item): bool => $item !== $subjectDate,
        ));
    ...
    public function addSubjectDescription(Text $subjectDescription): static
    {
    ...
    public function getSubjectDescription(): array
    {
        return $this->SubjectDescription;
    }

    public function removeSubjectDescription(Text $subjectDescription): static
    {
        $this->SubjectDescription = array_values(array_filter(
            $this->SubjectDescription,
            static fn ($item): bool => $item !== $subjectDescription,
        ));
